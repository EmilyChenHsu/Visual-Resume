...
{
	var open_container = '#tile0';
	// Find the first open tile_container
	for(var i = 0; i < 30; i++)
	{
		if($('#tile' + i).html() == '')
		//console.log($('#tile' + i).attr('title'));
		//if($('#tile' + i).attr('title') == '' || $('#tile' + i).attr('title') == undefined)
		{
			open_container = '#tile' + i;
			break;
		}
	}
	console.log(open_container);
	// ===== ===== ===== ===== ===== ===== ===== ===== ===== //
...
function tile_alt(source, type, tag, second)
{
	var open_container = '#tile0';
	// Find the first open tile_container
	for(var i = 0; i < 30; i++)
	...
	if(second != undefined)
	{
		tile(second[0],second[1],second[2]);
	}
}