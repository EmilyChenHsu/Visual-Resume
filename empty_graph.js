function empty_graph(id, type, community)
{
    ...
    //
  // ===== ===== ===== ===== ===== ===== ===== ===== ===== //
  // Begin draw empty graph for user's Commits activity ==>
  // ===== ===== ===== ===== ===== ===== ===== ===== ===== //
    else if(community === "gh_commit" && (type === "stacked" || type === "grouped"))
    {
        var x = d3.scale.ordinal()
          .rangeBands([0, global_width], .1);
  ...
  // ===== ===== ===== ===== ===== ===== ===== ===== ===== //
  // End draw empty graph for user's Commits activity <==
  // ===== ===== ===== ===== ===== ===== ===== ===== ===== //
